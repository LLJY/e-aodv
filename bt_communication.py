...
class BTCommunication:
    ...
    def _remove_connection(self, addr: str):
    ...
    def connect_to_node(self, addr: str, name: str) -> bool:
        """Connect to another E-AODV node"""
        ...
        try:
            ...
            logger.info(f"Device {addr} is paired, attempting connection")
            ...
            # Try connecting
            try:
                logger.info(f"Connecting to {addr} on port {RFCOMM_PORT}")
    ...
    def connect_to_node_with_backoff(self, addr: str, name: str, max_retries: int = 5) -> bool:
        """Legacy method - redirects to simplified connect_to_node"""
        return self.connect_to_node(addr, name)
